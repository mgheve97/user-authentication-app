...
const Register = () => {
  ...
  const { register, userInformation, errors, registrationSuccess } =
    useUserData();
  ...
  const HandleRegister = (e: React.FormEvent) => {
    ...
    const UpdatedInformationData = { ...informationdata, id: newID };

    // Call register
    register(UpdatedInformationData);
  };
            ...
            <div className="flex flex-col justify-between space-y-5 pt-5">
              ...
              <div className="flex flex-col justify-evenly space-y-5">
                ...
                <select
                  ...
                  className="block w-full px-4 py-2 text-lg border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  disabled={!SelectedRegions || Provinces.length === 0}
                  required
                >
              ...
              <div className="flex flex-col justify-evenly space-y-5">
                ...
                <select
                  ...
                  disabled={
                    !SelectedRegions ||
                    (SelectedRegions !== "130000000" && !SelectedProvinces)
                  }
                  required
                >
